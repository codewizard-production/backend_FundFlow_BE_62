...
@Entity(name = "Startup")
@Table(name = "\"Startup\"", schema =  "\"fundflow_be\"")
@Data
...
@Column(name = "\"KeyMetrics\"")
    ...
    @CollectionTable(schema = "\"fundflow_be\"", name = "\"StartupKeyMetrics\"",joinColumns = @JoinColumn(name = "\"SId\""))
...
@JoinTable(
            ...
            inverseJoinColumns = @JoinColumn( name="\"FId\""), schema = "\"fundflow_be\"")
...
@JoinTable(
            ...
            joinColumns = @JoinColumn( name="\"SId\""),
            inverseJoinColumns = @JoinColumn( name="\"RoundId\""), schema = "\"fundflow_be\"")
